    ...
    <div className="w-full h-screen flex flex-col px-3 justify-between">
      <div>
        <svg
          ...
          className="x1lliihq x1n2onr6 x5n08af my-8 ml-6 dark:text-white mb-10"
          fill="currentColor"
          height="29"
          role="img"
          viewBox="32 4 113 32"
        ...
        {SIDEBAR_MENU.map((item) => (
          ...
          >
            ...
            <span className="text-white ml-4 text-lg">{item.title}</span>
          </Link>
        ))}
      </div>
      <Link className="w-full flex items-center my-3 py-3 pl-6 hover:bg-dark-600 hover:bg-opacity-40 hover:rounded-lg">
        <IoReorderFour className="text-3xl text-white" />
        <span className="text-white ml-4 text-lg">More</span>
      </Link>
    </div>
  );
};
